...
`;
		...
		*/
		function createPanel(api, disposeRef) {
			ensureStyles();
			const state = {
				sandboxes: [],
				error: null,
		...
		*/
		function mountSettingsPanel(api, host) {
		...
		//#endregion
		//#region src/client/SandboxSettingsSection.tsx
		/** Settings content page for managing isolated plugin-development sandboxes. */
		function SandboxSettingsSection(_props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
				ref: host,
				className: "dshsb-settings-host",
				"aria-label": tt("panel.title")
			});
		}
		//#endregion
		//#region src/client/slot-registry.ts
		/** Register the sandbox page immediately after Agent presets. */
		function registerSandboxSettingsSection(ctx, section, label) {
		...
		*/
		function apply(ctx) {
			...
			registerSandboxSettingsSection(ctx, SandboxSettingsSection, () => tt("entry.label"));
		}
		//#endregion
		exports.apply = apply;
